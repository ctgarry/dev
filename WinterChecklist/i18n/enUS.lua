...
L.OPT_DOUBLE_WIDE_TT = "Expand the checklist to a wider layout for more breathing room."
L.OPT_TASK_ACTIONS = "Task actions"
L.OPT_EXPORT_BUTTON = "Export Tasks"
L.OPT_IMPORT_BUTTON = "Import Tasks"
