...
L.HELP_WELCOME             = "Welcome to WinterChecklist! This addon helps you keep track of short checklist items per character, such as holiday event tasks, profession cooldowns, or other repeatable tasks."
L.HELP_USING               = "Using WinterChecklist"
L.HELP_ADDING              = "To add a new task, type it into the 'Add a new task...' box and press Enter or click the + button. The task will be added to your list."
L.HELP_EDITING             = "To edit a task, click the pencil icon next to the task. Make your changes and click the checkmark to save or the X to cancel."
L.HELP_DELETING            = "To delete a task, click the trash can icon next to the task. You will be asked to confirm the deletion."
L.HELP_MARKING             = "To mark a task as complete or incomplete, click the checkbox next to the task."
L.HELP_FILTERING           = "Use the filter buttons at the top to show all tasks, only daily tasks, only weekly tasks, only incomplete tasks, or only complete tasks. Click 'Reset' to clear all filters."
L.HELP_PROFILES            = "Use the Profile section in Options to manage your profiles. You can create, rename, delete, copy, and merge profiles. Profiles allow you to maintain separate task lists for different characters or purposes."
L.HELP_IMPORT_EXPORT       = "Use the Import/Export section in Options to back up or share your tasks. You can export your tasks to a text format and import them back. When importing, you can choose to merge with existing tasks or replace them entirely."
L.HELP_FEEDBACK            = "Feedback and Support"
L.HELP_FEEDBACK_BODY       = "If you have any questions, suggestions, or encounter any issues, please visit the addon's page on CurseForge or GitHub to leave feedback or report bugs. Your input is valuable and helps improve the addon!"
...
L.IMPORT_INSTRUCTIONS      = "Paste the exported text from another character here and click Import. Existing tasks will be updated, new tasks will be added. To replace all existing tasks, select 'Import Replace' instead."
...
L.SLASH_CLEAR_CONFIRM      = "Are you sure you want to clear all tasks? This cannot be undone. Type /wcl reset all to clear tasks for all profiles."
L.SLASH_CLEAR_ALL_CONFIRM  = "Are you sure you want to clear all tasks for all profiles? This cannot be undone. Type /wcl reset all to confirm."
