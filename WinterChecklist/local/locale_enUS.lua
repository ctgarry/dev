...
L.HELP_BODY = table.concat({
  ...
  "• Radio buttons at the top filter: All / Daily / Weekly.",
  "• Click the ✎ (E on Classic) to edit, and 🗑 (X on Classic) to delete a row.",
  ...
  "• Slash: /wcl lock | unlock | toggle | minimap | import | export",
  "",
  "|cffffff00Commands|r",
  ...
  "/wcl import → import tasks from text",
  "/wcl export → export tasks to text",
