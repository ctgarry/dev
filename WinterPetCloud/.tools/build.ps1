...
function Copy-Project {
  ...
  # Ensure only the chosen TOC ships and is named WinterPetCloud.toc
  ...
  Copy-Item -Path $ChosenTocPath -Destination (Join-Path $DestDir "WinterPetCloud.toc") -Force
}
